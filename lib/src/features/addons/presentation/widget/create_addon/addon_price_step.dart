...
class AddOnPriceStep extends StatelessWidget {
  const AddOnPriceStep({super.key});
      ...
      builder: (context, state) {
        return Column(
          ...
          children: [
            ...
            Text(
              'This is what customers will pay for this add-on.',
              textAlign: TextAlign.center,
            ...
            Container(
              ...
              child: TextFormField(
                ...
                initialValue: (state.price == null || state.price == 0.0)
                    ? ''
                ...
                onChanged: (value) {
                  ...
                  cubit.updatePrice(parsed.toString());
                },
              ),
            ),
          ],
